...
**Maxim Tsigalko** is always injected as the first list row (tagged **Demo**) with typical wonderkid striker stats so you can **double-click** him and preview the profile panel before opening any `index.dat`. He is not read from your game files.
