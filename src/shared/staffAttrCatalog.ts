...
export const STAFF_REGULAR_ATTR_FILTERS: readonly StaffAttrFilterSpec[] = [
  ...
  { key: 'physiotherapy', label: 'Physiotherapy', source: 'np', npField: 'physiotherapy', section: 'regular' },
...
export const STAFF_HIDDEN_ATTR_FILTERS: readonly StaffAttrFilterSpec[] = [
  ...
  { key: 'business', label: 'Business (board)', source: 'np', npField: 'business', section: 'hidden' },
  ...
  { key: 'interference', label: 'Interference (board)', source: 'np', npField: 'interference', section: 'hidden' },
  ...
  { key: 'patience', label: 'Patience (board / tactics)', source: 'np', npField: 'patience', section: 'hidden' },
  { key: 'pressing', label: 'Pressing', source: 'np', npField: 'pressing', section: 'hidden' },
  { key: 'resources', label: 'Resources (sugar daddy)', source: 'np', npField: 'resources', section: 'hidden' },
