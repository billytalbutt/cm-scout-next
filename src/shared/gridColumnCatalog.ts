...
const CORE: GridColumnCatalogEntry[] = [
  ...
  { id: 'curApps', label: 'Cur Apps', group: 'Season & career' },
  { id: 'curGoals', label: 'Cur Gls', group: 'Season & career' },
  { id: 'curAst', label: 'Cur Ast', group: 'Season & career' },
  { id: 'curAvR', label: 'Cur AvR', group: 'Season & career' },
  { id: 'carApps', label: 'Car Apps', group: 'Season & career' },
  { id: 'carGoals', label: 'Car Gls', group: 'Season & career' },
  ...
  { id: 'csApps', label: 'CS Senior apps', group: 'CM save season' },
  { id: 'csGoals', label: 'CS Senior gls', group: 'CM save season' },
  { id: 'csAst', label: 'CS Senior ast', group: 'CM save season' },
  { id: 'csAvR', label: 'CS Senior AvR', group: 'CM save season' },
  { id: 'csLeagueGoals', label: 'CS League gls', group: 'CM save season' },
  ...
  { id: 'isRegen', label: 'Regen status', group: 'Regen' },
  { id: 'regenOf', label: 'Regen of', group: 'Regen' },
