...
import { CONTRACT_ISSUE_BLOCK_LENGTH, CONTRACT_ISSUE_BLOCK_OFFSET } from './database/contractDiskLayout'
...
describe('buildPatchedArchiveBuffer clearUnhappiness', () => {
  it('sets morale, clears staff club valuation, and clears contract issue block', () => {
    ...
    expect(built.buffer.readUInt8(STAFF_BLOCK_POS + 0x60)).toBe(0)
