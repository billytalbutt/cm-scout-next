...
function baseRow(r: UiPlayerRow): GridPlayerRow {
  return {
    ...
    disciplineRisk: r.disciplineRisk,
    lowConsistencyRisk: r.lowConsistencyRisk,
    ...
    curSeasonApps: r.curSeasonApps,
    curSeasonGoals: r.curSeasonGoals,
    curSeasonAssists: r.curSeasonAssists,
    curSeasonAvgRating: r.curSeasonAvgRating,
    careerAppsTotal: r.careerAppsTotal,
    careerGoalsTotal: r.careerGoalsTotal,
